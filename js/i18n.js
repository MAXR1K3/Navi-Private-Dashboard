...
(function(){
  var extra={
    ...
    zh:{
      ...
      snapDeleted:"存档已删除",
      snapExport:"导出", snapImport:"导入", snapLocalOnly:"存档只保存在这台设备上，不随 bookmarks.json 和 WebDAV 同步走。导出可以留一份备份，或搬到另一台设备。", snapNothingToExport:"还没有可导出的存档", snapExported:"已导出 {n} 篇存档", snapImported:"新增 {added} 篇，更新 {replaced} 篇，跳过 {skipped} 篇", snapImportBad:"这不是 Navi 的存档包文件", snapStorage:"页面存档", snapStorageVal:"{n} 个页面 · {kb} KB",
    ...
    es:{
      ...
      snapExport:"Exportar", snapImport:"Importar", snapLocalOnly:"Los archivos se quedan en este dispositivo: no forman parte de bookmarks.json ni de la sincronización WebDAV. Expórtalos para tener una copia o llevarlos a otro dispositivo.", snapNothingToExport:"Todavía no hay archivos que exportar", snapExported:"{n} archivo(s) exportado(s)", snapImported:"{added} añadidos, {replaced} actualizados, {skipped} omitidos", snapImportBad:"Ese archivo no es un paquete de archivos de Navi", snapStorage:"Archivos de páginas", snapStorageVal:"{n} página(s) · {kb} KB",
