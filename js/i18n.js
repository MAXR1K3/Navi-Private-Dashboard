...
(function(){
  var extra={
    ...
    zh:{
      ...
      logSetMotion:"动效模式 → {v}", logSetLang:"语言 → {v}", logSetMonitor:"更新内网监控设置", logSetAi:"更新 AI 建议设置", logSetBg:"更改背景", logSetName:"修改页面名称", logSetTag:"修改副标题", logSetCatLayout:"更改分类样式", logSetClock:"切换时钟秒显示", logSetHolidays:"切换节假日显示", logSetGlass:"更改玻璃质感", logSetWidgets:"调整组件显示", logSetWidgetOrder:"调整组件顺序", logSetWidgetSize:"调整组件大小", logSetRetention:"更改回收站保留时长", logSetSync:"切换 Chrome 同步", logSetLogo:"更改 Logo", logSetGeneric:"更改设置：{k}", logSetMultiple:"更改了 {n} 项设置",
      logUndo:"已撤销：{msg}"
    },
    es:{
      ...
      logSetMotion:"Animación → {v}", logSetLang:"Idioma → {v}", logSetMonitor:"Monitor de red actualizado", logSetAi:"Sugerencias de IA actualizadas", logSetBg:"Fondo cambiado", logSetName:"Nombre cambiado", logSetTag:"Subtítulo cambiado", logSetCatLayout:"Estilo de categorías cambiado", logSetClock:"Segundos del reloj", logSetHolidays:"Festivos", logSetGlass:"Efecto de cristal cambiado", logSetWidgets:"Visibilidad de widgets", logSetWidgetOrder:"Widgets reordenados", logSetWidgetSize:"Tamaño de widget", logSetRetention:"Retención de papelera", logSetSync:"Sincronización de Chrome", logSetLogo:"Logo cambiado", logSetGeneric:"Ajuste cambiado: {k}", logSetMultiple:"{n} ajustes cambiados",
