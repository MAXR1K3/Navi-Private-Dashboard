...
var I18N = {
  en:{
    ...
    select:"Select", import:"Import", add:"Add", settings:"Settings", more:"More", moreSheetTitle:"Tools & management", menuTransfer:"Import & export", menuAi:"AI tools", menuMaintenance:"Maintenance", menuDanger:"Danger zone",
    ...
    setLocation:"Set a location to see local weather.", weatherSetup:"Set up weather", enterCity:"Enter a city…", setBtn:"Set", useMyLocation:"Use my location",
    ...
    categoriesSec:"Categories", categoryStyle:"Category style", layoutTabs:"Tabs", layoutDrawer:"Drawer", categoriesTitle:"Categories",
    ...
    captureSavedOne:"Saved “{title}”", captureSaved:"Saved {n} page(s)", captureDup:"Already in your bookmarks",
  ...
  zh:{
    ...
    select:"选择", import:"导入", add:"添加", settings:"设置", more:"更多", moreSheetTitle:"工具与管理", menuTransfer:"导入导出", menuAi:"AI 工具", menuMaintenance:"维护", menuDanger:"危险操作",
    ...
    setLocation:"设置位置后即可查看本地天气。", weatherSetup:"设置天气", enterCity:"输入城市…", setBtn:"设置", useMyLocation:"使用我的位置",
    ...
    categoriesSec:"分类", categoryStyle:"分类样式", layoutTabs:"标签", layoutDrawer:"抽屉", categoriesTitle:"分类",
    ...
    captureSavedOne:"已收藏「{title}」", captureSaved:"已收藏 {n} 个页面", captureDup:"该页面已在书签中",
  ...
  es:{
    ...
    select:"Seleccionar", import:"Importar", add:"Añadir", settings:"Ajustes", more:"Más", moreSheetTitle:"Herramientas y gestión", menuTransfer:"Importar y exportar", menuAi:"Herramientas de IA", menuMaintenance:"Mantenimiento", menuDanger:"Zona de riesgo",
    ...
    setLocation:"Define una ubicación para ver el clima local.", weatherSetup:"Configurar el clima", enterCity:"Escribe una ciudad…", setBtn:"Definir", useMyLocation:"Usar mi ubicación",
    ...
    categoriesSec:"Categorías", categoryStyle:"Estilo de categorías", layoutTabs:"Pestañas", layoutDrawer:"Cajón", categoriesTitle:"Categorías",
    ...
    captureSavedOne:"Guardado «{title}»", captureSaved:"{n} página(s) guardada(s)", captureDup:"Ya está en tus marcadores",
...
(function(){
  var extra={
    en:{
      ...
      monDocker:"Docker", monRunning:"running", monSmart:"SMART", monDisks:"disks", monUps:"UPS", monBackup:"Backup", monUptime:"Uptime", monTrendSpan:"Last {span}", monTrendPeak:"peak {v}", monTrendClear:"Clear history",
      monAlertsLabel:"Threshold alerts", monAlertsDesc:"Warn when a metric stays over its limit for several samples in a row.", monAlertLimits:"Limits", monAlertSustain:"Consecutive samples", monAlertSustainDesc:"How many samples in a row must exceed the limit before alerting.", monAlertTitle:"{n} over limit", monAlertTip:"{value} — limit {limit}", monAlertOne:"{name} at {value} (limit {limit})", monAlertMany:"{n} metrics over their limits",
      ...
      webdavUrl:"bookmarks.json URL", webdavUser:"Username (optional)", webdavPass:"Password (optional)", webdavAuto:"Auto-sync on open", webdavAutoDesc:"Fetch the latest on every open; otherwise use the cached copy.", webdavAutoUpload:"Upload after browser sync", webdavAutoUploadDesc:"After Chrome or Edge bookmark sync finishes, write the latest bookmarks.json to WebDAV/NAS.", syncTimeout:"No answer within {s}s — the server may be asleep or a firewall is dropping the connection.", syncCorsBlocked:"Server reachable, but the browser is blocking it (CORS). Allow OPTIONS without auth, plus PUT and the Authorization/Content-Type headers on your reverse proxy.", syncMixedContent:"This page is https but the address is http — browsers block that. Use an https address for the NAS.", syncUnreachable:"No response from that address. Check the host, port and that you are on the same network.", mirrorRoleLabel:"This browser's role", mirrorRoleDesc:"Pick one browser as the anchor. Other browsers mirror its bookmarks into a folder of their own and never write back. Stored on this browser only.", mirrorRoleOff:"Off", mirrorRoleAnchor:"Anchor", mirrorRoleFollower:"Mirror", mirrorRoleSaved:"Role saved for this browser", mirrorRunLabel:"Mirror into this browser", mirrorPreview:"Preview", mirrorRun:"Mirror now", mirrorInto:"Writes only inside the “{folder}” folder", mirrorLastRun:"last run {when}", mirrorNeedsExt:"Needs the Navi extension in this browser", mirrorAlreadyInSync:"Already up to date", mirrorPreviewTitle:"Mirror preview", mirrorPreviewMsg:"Add {add}, update {update}, remove {remove}. Only the “{folder}” folder is touched — bookmarks you keep elsewhere in this browser are never changed.", mirrorProgress:"Mirroring {done}/{total}…", mirrorDone:"Mirrored {n} change(s) into “{folder}”", mirrorFailed:"Mirror failed: {msg}", mirrorFollowerNoPush:"This browser is set to mirror, so it does not send its bookmarks back.", syncStatusLabel:"Sync status", syncNow:"Sync now", webdavUploadNow:"Upload to NAS", webdavCorsNote:"PWA reads need CORS or a reverse proxy. The desktop extension can upload the same bookmarks.json with WebDAV PUT.",
      ...
      syncCompatibilityTitle:"Server cannot guarantee safe writes", syncCompatibilityMsg:"This WebDAV server did not provide a strong ETag, so it cannot prevent another device from changing the file during upload. Read the remote file again and continue with a compatibility upload?",
      syncConflictSummary:"{n} choice(s) need attention · auto-merged +{added}, updated {updated}, deleted {deleted}", syncConflictRemaining:"Choose a side for {n} remaining item(s).", syncConflictReady:"All choices are complete.", syncConflictApplying:"Applying choices and checking the remote file…", syncConflictIncomplete:"Choose local or remote for every conflict before applying.",
      syncAllLocal:"All local", syncAllRemote:"All remote", syncConflictApply:"Apply choices and sync safely", syncConflictLocal:"Local", syncConflictRemote:"Remote", syncConflictDeleted:"Deleted", syncConflictEmpty:"No value", syncConflictItems:"{n} item(s)",
      syncConflictKindBookmark:"Bookmark", syncConflictKindOrder:"Bookmark order", syncConflictKindCategories:"Categories", syncConflictKindCalendar:"Calendar", syncConflictKindSettings:"Interface settings", syncConflictKindBootstrap:"First sync",
      syncConflictDownloadRemote:"Download remote file", syncConflictUseLocalEtag:"Use local with current ETag", syncConflictNoStrongEtag:"Safe overwrite is unavailable because the server did not provide a strong ETag.", syncConflictUnreadableHelp:"The remote response is kept untouched. Download it to inspect before deciding whether to replace it.",
      syncBootstrapLocal:"Keep this device", syncBootstrapRemote:"Use the remote file", syncBootstrapMerge:"Combine both sides", syncBootstrapChoice:"Choose how to establish the first shared version.",
    ...
    zh:{
      ...
      monDocker:"Docker", monRunning:"运行中", monSmart:"SMART", monDisks:"块盘", monUps:"UPS", monBackup:"备份", monUptime:"运行时长", monTrendSpan:"最近 {span}", monTrendPeak:"峰值 {v}", monTrendClear:"清除历史",
      monAlertsLabel:"阈值告警", monAlertsDesc:"某项指标连续多次超过限值时发出提醒。", monAlertLimits:"限值", monAlertSustain:"连续采样次数", monAlertSustainDesc:"连续多少次采样超过限值才触发告警。", monAlertTitle:"{n} 项超限", monAlertTip:"{value} —— 限值 {limit}", monAlertOne:"{name} 已达 {value}（限值 {limit}）", monAlertMany:"{n} 项指标超过限值",
      ...
      webdavUrl:"bookmarks.json 地址", webdavUser:"用户名（可选）", webdavPass:"密码（可选）", webdavAuto:"打开时自动同步", webdavAutoDesc:"每次打开拉取最新；否则使用缓存副本。", webdavAutoUpload:"浏览器同步后上传", webdavAutoUploadDesc:"Chrome 或 Edge 书签同步完成后，把最新 bookmarks.json 写入 WebDAV/NAS。", syncTimeout:"{s} 秒内没有响应——服务器可能在休眠，或者被防火墙丢包了。", syncCorsBlocked:"服务器能连上，是浏览器的跨域策略挡住了。请在反向代理上放行不带认证的 OPTIONS 预检，以及 PUT 方法和 Authorization / Content-Type 请求头。", syncMixedContent:"当前页面是 https，而地址是 http，浏览器会直接拦截。请给 NAS 配一个 https 地址。", syncUnreachable:"这个地址没有响应。检查主机、端口，以及是否在同一个网络里。", mirrorRoleLabel:"这台浏览器的角色", mirrorRoleDesc:"选一台浏览器作为锚点，其它浏览器把它的书签镜像到自己的一个文件夹里，并且不回写。该设置只记在这台浏览器上。", mirrorRoleOff:"不参与", mirrorRoleAnchor:"锚点", mirrorRoleFollower:"镜像", mirrorRoleSaved:"已保存这台浏览器的角色", mirrorRunLabel:"镜像到这台浏览器", mirrorPreview:"预览", mirrorRun:"立即镜像", mirrorInto:"只写入「{folder}」这个文件夹", mirrorLastRun:"上次 {when}", mirrorNeedsExt:"需要在这台浏览器里安装 Navi 扩展", mirrorAlreadyInSync:"已经是最新的", mirrorPreviewTitle:"镜像预览", mirrorPreviewMsg:"新增 {add} 条，更新 {update} 条，删除 {remove} 条。只会动「{folder}」这个文件夹，你在这台浏览器别处存的书签不受任何影响。", mirrorProgress:"正在镜像 {done}/{total}…", mirrorDone:"已镜像 {n} 处改动到「{folder}」", mirrorFailed:"镜像失败：{msg}", mirrorFollowerNoPush:"这台浏览器设为镜像端，不会把书签回传。", syncStatusLabel:"同步状态", syncNow:"立即同步", webdavUploadNow:"上传到 NAS", webdavCorsNote:"PWA 读取需要 CORS 或反向代理；桌面扩展可通过 WebDAV PUT 上传同一份 bookmarks.json。",
      ...
      syncCompatibilityTitle:"服务器无法保证安全写入", syncCompatibilityMsg:"这个 WebDAV 服务器没有提供强 ETag，无法阻止另一台设备在上传期间修改文件。是否重新读取远端后，以兼容模式继续上传？",
      syncConflictSummary:"有 {n} 项需要选择 · 已自动合并：新增 {added}、更新 {updated}、删除 {deleted}", syncConflictRemaining:"还有 {n} 项需要选择本地或远程。", syncConflictReady:"所有冲突都已选择。", syncConflictApplying:"正在应用选择并重新检查远程文件…", syncConflictIncomplete:"请为每个冲突选择本地或远程后再应用。",
      syncAllLocal:"全部用本地", syncAllRemote:"全部用远程", syncConflictApply:"应用选择并安全同步", syncConflictLocal:"本地", syncConflictRemote:"远程", syncConflictDeleted:"已删除", syncConflictEmpty:"无内容", syncConflictItems:"{n} 项",
      syncConflictKindBookmark:"书签", syncConflictKindOrder:"书签顺序", syncConflictKindCategories:"分类", syncConflictKindCalendar:"日历", syncConflictKindSettings:"界面设置", syncConflictKindBootstrap:"首次同步",
      syncConflictDownloadRemote:"下载远程原文", syncConflictUseLocalEtag:"基于当前 ETag 使用本地", syncConflictNoStrongEtag:"服务器没有提供强 ETag，当前不能安全覆盖远程文件。", syncConflictUnreadableHelp:"远程响应会保持原样。建议先下载检查，再决定是否替换。",
      syncBootstrapLocal:"保留这台设备", syncBootstrapRemote:"采用远程文件", syncBootstrapMerge:"合并两边内容", syncBootstrapChoice:"请选择如何建立第一份共同版本。",
    ...
    es:{
      ...
      monDocker:"Docker", monRunning:"activos", monSmart:"SMART", monDisks:"discos", monUps:"SAI", monBackup:"Copia", monUptime:"Actividad", monTrendSpan:"Últimos {span}", monTrendPeak:"pico {v}", monTrendClear:"Borrar historial",
      monAlertsLabel:"Alertas de umbral", monAlertsDesc:"Avisa cuando una métrica supera su límite varias muestras seguidas.", monAlertLimits:"Límites", monAlertSustain:"Muestras consecutivas", monAlertSustainDesc:"Cuántas muestras seguidas deben superar el límite antes de alertar.", monAlertTitle:"{n} sobre el límite", monAlertTip:"{value} — límite {limit}", monAlertOne:"{name} en {value} (límite {limit})", monAlertMany:"{n} métricas sobre su límite",
      ...
      webdavUrl:"URL de bookmarks.json", webdavUser:"Usuario (opcional)", webdavPass:"Contraseña (opcional)", webdavAuto:"Sincronizar al abrir", webdavAutoDesc:"Trae lo último en cada apertura; si no, usa la copia en caché.", webdavAutoUpload:"Subir tras sincronizar navegador", webdavAutoUploadDesc:"Cuando termine la sincronización de Chrome o Edge, escribe el bookmarks.json actualizado en WebDAV/NAS.", syncTimeout:"Sin respuesta en {s}s: puede que el servidor esté suspendido o un cortafuegos esté descartando la conexión.", syncCorsBlocked:"El servidor responde, pero el navegador lo bloquea (CORS). Permite OPTIONS sin autenticación, además de PUT y las cabeceras Authorization/Content-Type en tu proxy inverso.", syncMixedContent:"Esta página es https y la dirección es http: el navegador lo bloquea. Usa una dirección https para el NAS.", syncUnreachable:"Esa dirección no responde. Revisa el host, el puerto y que estés en la misma red.", mirrorRoleLabel:"Rol de este navegador", mirrorRoleDesc:"Elige un navegador como ancla. Los demás reflejan sus marcadores en una carpeta propia y nunca escriben de vuelta. Se guarda solo en este navegador.", mirrorRoleOff:"Desactivado", mirrorRoleAnchor:"Ancla", mirrorRoleFollower:"Espejo", mirrorRoleSaved:"Rol guardado para este navegador", mirrorRunLabel:"Reflejar en este navegador", mirrorPreview:"Vista previa", mirrorRun:"Reflejar ahora", mirrorInto:"Solo escribe dentro de la carpeta «{folder}»", mirrorLastRun:"última vez {when}", mirrorNeedsExt:"Requiere la extensión de Navi en este navegador", mirrorAlreadyInSync:"Ya está al día", mirrorPreviewTitle:"Vista previa del espejo", mirrorPreviewMsg:"Añadir {add}, actualizar {update}, eliminar {remove}. Solo se toca la carpeta «{folder}»; los marcadores que tengas en otros sitios de este navegador no cambian.", mirrorProgress:"Reflejando {done}/{total}…", mirrorDone:"{n} cambio(s) reflejado(s) en «{folder}»", mirrorFailed:"Error al reflejar: {msg}", mirrorFollowerNoPush:"Este navegador está en modo espejo, así que no reenvía sus marcadores.", syncStatusLabel:"Estado de sincronización", syncNow:"Sincronizar", webdavUploadNow:"Subir al NAS", webdavCorsNote:"La PWA necesita CORS o un proxy inverso para leer. La extensión de escritorio puede subir el mismo bookmarks.json con WebDAV PUT.",
      ...
      syncCompatibilityTitle:"El servidor no garantiza escrituras seguras", syncCompatibilityMsg:"Este servidor WebDAV no proporcionó un ETag fuerte, por lo que no puede impedir cambios de otro dispositivo durante la subida. ¿Volver a leer el remoto y continuar en modo de compatibilidad?",
      syncConflictSummary:"{n} elección(es) requieren atención · combinación automática: +{added}, actualizadas {updated}, eliminadas {deleted}", syncConflictRemaining:"Elige un lado para {n} elemento(s) pendiente(s).", syncConflictReady:"Todas las elecciones están completas.", syncConflictApplying:"Aplicando elecciones y comprobando de nuevo el archivo remoto…", syncConflictIncomplete:"Elige local o remoto para cada conflicto antes de aplicar.",
      syncAllLocal:"Todo local", syncAllRemote:"Todo remoto", syncConflictApply:"Aplicar elecciones y sincronizar con seguridad", syncConflictLocal:"Local", syncConflictRemote:"Remoto", syncConflictDeleted:"Eliminado", syncConflictEmpty:"Sin valor", syncConflictItems:"{n} elemento(s)",
      syncConflictKindBookmark:"Marcador", syncConflictKindOrder:"Orden de marcadores", syncConflictKindCategories:"Categorías", syncConflictKindCalendar:"Calendario", syncConflictKindSettings:"Ajustes de interfaz", syncConflictKindBootstrap:"Primera sincronización",
      syncConflictDownloadRemote:"Descargar archivo remoto", syncConflictUseLocalEtag:"Usar local con el ETag actual", syncConflictNoStrongEtag:"No se puede sobrescribir con seguridad porque el servidor no proporcionó un ETag fuerte.", syncConflictUnreadableHelp:"La respuesta remota se conserva intacta. Descárgala para revisarla antes de decidir si la sustituyes.",
      syncBootstrapLocal:"Conservar este dispositivo", syncBootstrapRemote:"Usar el archivo remoto", syncBootstrapMerge:"Combinar ambos lados", syncBootstrapChoice:"Elige cómo establecer la primera versión compartida.",
...
(function(){
  var extra={
    en:{
      ...
      worldClock:"World clocks", worldClockEmpty:"Add a city or time zone to compare time.", worldClockSetup:"Add world clock", worldClockPh:"Search city or time zone…", addClock:"Add", removeClock:"Remove clock", clockStack:"Stack", clockCompact:"Compact",
    ...
    zh:{
      ...
      worldClock:"世界时钟", worldClockEmpty:"添加城市或时区，快速对照时间。", worldClockSetup:"添加世界时钟", worldClockPh:"搜索城市或时区…", addClock:"添加", removeClock:"移除时钟", clockStack:"堆栈", clockCompact:"紧凑",
    ...
    es:{
      ...
      worldClock:"Relojes mundiales", worldClockEmpty:"Añade una ciudad o zona horaria.", worldClockSetup:"Añadir reloj mundial", worldClockPh:"Buscar ciudad o zona horaria…", addClock:"Añadir", removeClock:"Quitar reloj", clockStack:"Pila", clockCompact:"Compacto",
...
(function(){
  var extra={
    en:{
      ...
      snapExport:"Export", snapImport:"Import", snapLocalOnly:"Archives stay on this device — they are not part of bookmarks.json or WebDAV sync. Export them to keep a backup or move them to another device.", snapNothingToExport:"No archives to export yet", snapExported:"Exported {n} archive(s)", snapImported:"Imported {added}, updated {replaced}, skipped {skipped}", snapImportBad:"That file is not a Navi archive bundle", mobileCollapseLabel:"Collapse dashboard on phones", mobileCollapseDesc:"On narrow screens the widgets stack into one tall column and push bookmarks several screens down. Collapsed by default; one tap opens it, and that choice stays on this device.", mobileWidgetsLabel:"Widgets shown on phones", mobileWidgetsDesc:"Tap to exclude a widget on narrow screens. It stays on wider screens.", mobileWidgetsNone:"No widgets enabled yet", snapStorage:"Page archives", snapStorageVal:"{n} page(s) · {kb} KB",
    ...
    zh:{
      ...
      snapDeleted:"存档已删除",
      snapExport:"导出", snapImport:"导入", snapLocalOnly:"存档只保存在这台设备上，不随 bookmarks.json 和 WebDAV 同步走。导出可以留一份备份，或搬到另一台设备。", snapNothingToExport:"还没有可导出的存档", snapExported:"已导出 {n} 篇存档", snapImported:"新增 {added} 篇，更新 {replaced} 篇，跳过 {skipped} 篇", snapImportBad:"这不是 Navi 的存档包文件", mobileCollapseLabel:"手机上折叠仪表盘", mobileCollapseDesc:"窄屏下小组件会堆成很高的一列，把书签压到好几屏以下。默认折叠，点一下即展开，而且这个选择只记在这台设备上。", mobileWidgetsLabel:"手机上显示的组件", mobileWidgetsDesc:"点一下可以让某个组件在窄屏时不显示，宽屏不受影响。", mobileWidgetsNone:"还没有启用任何组件", snapStorage:"页面存档", snapStorageVal:"{n} 个页面 · {kb} KB",
    ...
    es:{
      ...
      snapExport:"Exportar", snapImport:"Importar", snapLocalOnly:"Los archivos se quedan en este dispositivo: no forman parte de bookmarks.json ni de la sincronización WebDAV. Expórtalos para tener una copia o llevarlos a otro dispositivo.", snapNothingToExport:"Todavía no hay archivos que exportar", snapExported:"{n} archivo(s) exportado(s)", snapImported:"{added} añadidos, {replaced} actualizados, {skipped} omitidos", snapImportBad:"Ese archivo no es un paquete de archivos de Navi", mobileCollapseLabel:"Contraer el panel en móviles", mobileCollapseDesc:"En pantallas estrechas los widgets se apilan en una columna muy alta y empujan los marcadores varias pantallas hacia abajo. Contraído por defecto; un toque lo abre y esa elección se queda en este dispositivo.", mobileWidgetsLabel:"Widgets visibles en móviles", mobileWidgetsDesc:"Toca para excluir un widget en pantallas estrechas. Se mantiene en pantallas anchas.", mobileWidgetsNone:"Aún no hay widgets activados", snapStorage:"Archivos de páginas", snapStorageVal:"{n} página(s) · {kb} KB",
